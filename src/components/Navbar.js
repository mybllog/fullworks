...
import image6 from '../assets/img/logo1-removebg-preview.png'
const Navbar = () => {
                  ...
                  <img src={image6} alt='logo' className=' h-16'/>
                    ...
                    <div className={`hidden lg:flex md:flex xl:flex  gap-8  justify-end float-end relative  md:right-16 lg:left-28 xl:left-28 ${textColor} `}>
                        <a
                            href="/"
                        >
                           <text  className={` text-black  hover:text-pink-400 transition-colors text-base text-center font-bold not-italic`}>Home</text> 
                        </a>
                        <a
                            href="/about-us"
                           
                        >
                           <text   className={` text-black  hover:text-pink-400 transition-colors text-base text-center font-bold not-italic`}>About Us</text> 
                        </a>
                        <a
                            href="/services"
                        >
                            <text  className={`  text-black  hover:text-pink-400  transition-colors text-base text-center font-bold not-italic`}>Services</text>
                        </a>
                        <a
                            href="/contact-us"
                           
                        >
                           <text  className={`  text-black  hover:text-pink-400 transition-colors text-base text-center font-bold not-italic`}>Contact Us</text> 
                        </a>
